...
export function Sheet({ open, onOpenChange, children, title }: SheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-end justify-center">
      <div
        ref={scrimRef}
        className="absolute inset-0 bg-bg/82 backdrop-blur-[6px] animate-[modal-backdrop-in_0.25s_ease_both]"
      ...
      <div
        ...
        className={cn(
          ...
          'bg-surface border border-border-gold border-b-0 rounded-t-[20px]',
          'px-5 py-5 pb-7',
