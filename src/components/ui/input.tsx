...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      type={type}
      className={cn(
        'h-11 w-full rounded-[10px] border border-border-gold bg-bg/60 px-3.5 text-base text-fg shadow-sm outline-none transition-[border-color,box-shadow] duration-200 will-change-auto',
