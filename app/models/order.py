...
class Order(Base):
    ...
    pay_type: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="支付通道 wx_h5/ali_h5/wx_native/ali_qr")
    pay_url: Mapped[str | None] = mapped_column(Text, nullable=True, comment="收钱吧 WAP 跳转 URL")
    code_url: Mapped[str | None] = mapped_column(Text, nullable=True, comment="收钱吧聚合码预下单短链")
